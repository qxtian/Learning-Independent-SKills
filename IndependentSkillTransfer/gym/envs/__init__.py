...
register(
    id='HalfCheetah_hurdle-v0',
    entry_point='gym.envs.mujoco:HalfCheetahEnv_Hurdle',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)

register(
    id='HalfCheetah_hurdle-v2',
    entry_point='gym.envs.mujoco:HalfCheetahEnv_Hurdle_v2',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)

register(
    id='HalfCheetah_hurdle-v3',
    entry_point='gym.envs.mujoco:HalfCheetahEnv_Hurdle_v3',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
register(
    id='hopper_v3_hurdle',
    entry_point='gym.envs.mujoco:hopper_v3_hurdle',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
#    id='Walker2d-v0',
#    max_episode_steps=1000,
#    entry_point='gym.envs.mujoco:Walker2dEnvV0',
#)
...
# Forward and jump
register(
    id='Walker2dHurdle-v0',
    entry_point='gym.envs.mujoco:Walker2dHurdleEnvV0',
...
register(
    id='JacoCatch-v1',
    entry_point='gym.envs.mujoco:JacoCatchEnv',
    max_episode_steps=200,
)

register(
    id='JacoToss-v1',
    entry_point='gym.envs.mujoco:JacoTossEnv',
    max_episode_steps=200,
    kwargs={'with_rot': 0},
)
...
register(
    id='JacoHit-v1',
    entry_point='gym.envs.mujoco:JacoHitEnv',
    max_episode_steps=200,
    kwargs={'with_rot': 0},
)
...
register(
    id='JacoKeepPick-v1',
    entry_point='gym.envs.mujoco:JacoKeepPickEnv',
    max_episode_steps=1000,
)
...
register(
    id='JacoKeepCatch-v1',
    entry_point='gym.envs.mujoco:JacoKeepCatchEnv',
    max_episode_steps=1000,
)
...
register(
    id='JacoServe-v1',
    entry_point='gym.envs.mujoco:JacoServeEnv',
