...
if __name__ == "__main__":
    ...
    output_dir = './network_reserve/model_2323_diversity_combine/'
    ...
    for episode_idx in range(MAX_EPISODE):
        ...
        for epoch in range(MAX_EPOCH):
            ...
            for step in range(MAX_STEP):
                ...
                # print(weight)
                action_weight_sum = diversity_Skill.forward(state, weight)
                nxt_state, reward, done, info = env.step(action_weight_sum)
